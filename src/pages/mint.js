...
//console.log(accounts)
	...
	const renderHandleButton = () => {
		...
		else 
		{
			...
			return <GridCol sm={12} md={6}>
				<MintLabel for="qty">How many?</MintLabel><InputWrapper><InputArrows onClick={decreaseClick}>-</InputArrows><MintInput onChange={handleInput} type="number" name="Qty" id="Qty" max="50" min="1" value={inputValue}/><InputArrows onClick={increaseClick}>+</InputArrows></InputWrapper>
